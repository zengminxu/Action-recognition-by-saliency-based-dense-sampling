...
template <int D> bool CmGMM_<D>::Save(CStr &name) const
{
	...
	cout<<"CmGMM_<D>::Load() CV_Assert(fwrite()) sizeof(CmGaussian):"<<sizeof(CmGaussian)<<endl;
#else
...
template <int D> bool CmGMM_<D>::Load(CStr &name)
{
	...
	cout<<"CmGMM_<D>::Load() L2 = sizeof(CmGaussian*):"<<L2<<endl;
#else
	...
	cout<<"CmGMM_<D>::Load() int g = fread() sizeof(CmGaussian):"<<sizeof(CmGaussian)<<endl;
#else
